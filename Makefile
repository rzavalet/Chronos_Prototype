...
CFLAGS=		-c -I$(INCLUDEDIR) -I/usr/local/BerkeleyDB.6.2/include -g -Wall -DCHRONOS_DEBUG -DCHRONOS_USER_TRANSACTIONS_ENABLED -DBENCHMARK_DEBUG -DCHRONOS_ALL_TXN_AVAILABLE 
#-DCHRONOS_UPDATE_TRANSACTIONS_ENABLED
