...
CFLAGS=		-c -I$(INCLUDEDIR) -I/usr/local/BerkeleyDB.6.2/include -g -Wall -DCHRONOS_DEBUG -DCHRONOS_USER_TRANSACTIONS_ENABLED -DCHRONOS_UPDATE_TRANSACTIONS_ENABLED -DCHRONOS_SAMPLING_ENABLED -DBENCHMARK_DEBUG
CCLINK=		$(LIBTOOL) --mode=link cc
LDFLAGS=
